...
!function (NioApp, $) {
  ...
  var profileBalance = {
    ...
    datasets: [{
      ...
      color: "#612ECC",
      background: NioApp.hexRGB('#612ECC', .3),
        ...
        options: {
          ...
          scales: {
            y: {
              ...
              grid: {
                color: NioApp.hexRGB("#612ECC", .2),
                tickLength: 0,
                zeroLineColor: NioApp.hexRGB("#612ECC", .2),
                drawTicks: false
              }
            },
            x: {
  ...
  var salesRevenue = {
    ...
    datasets: [{
      label: "Sales Revenue",
      color: [NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), "#612ECC"],
  ...
  var activeSubscription = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), "#612ECC"],
