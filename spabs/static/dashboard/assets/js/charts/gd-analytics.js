...
!function (NioApp, $) {
    ...
    if ($(elm).exists() && typeof $.fn.vectorMap === 'function') {
      $(elm).each(function () {
        ...
        $self.vectorMap({
          ...
          scaleColors: ['#ccd7e2', '#612ECC'],
          selectedColor: '#612ECC',
          showTooltip: true,
  ...
  var TrafficChannelDoughnutData = {
    ...
    datasets: [{
      borderColor: "#fff",
      background: ["#612ECC", "#b8acff", "#ffa9ce", "#f9db7b"],
  ...
  var OrganicSearchData = {
    ...
    datasets: [{
      ...
      color: "#612ECC",
      background: NioApp.hexRGB('#612ECC', .25),
  ...
  var analyticOvData = {
    ...
    datasets: [{
      ...
      color: "#612ECC",
      dash: [0, 0],
      background: NioApp.hexRGB('#612ECC', .15),
