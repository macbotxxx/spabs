...
!function (NioApp, $) {
  ...
  var totalDeposit = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), NioApp.hexRGB("#612ECC", .2), "#612ECC"],
